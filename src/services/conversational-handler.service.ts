...
export class ConversationalHandler {
  ...
  async handleMessage(
    ...
    try {
      ...
      // Fallback response
      return {
        response: 'Desculpe, tive um problema ao processar sua mensagem. Pode reformular ou digite *vendedor* para falar com nossa equipe? 🤔',
        updatedState: state
      };
    }
  }
